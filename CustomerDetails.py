...
class CustomerDetails:
    ...
    def __int__(self, cust_series: Series):
        ...
        self.credit_mix = cust_series.get('credit_mix', '').lower()
        ...
        self.payment_of_min_amount = cust_series.get('payment_of_min_amount', '').lower()
        ...
        self.payment_behaviour = cust_series.get('payment_behaviour', '').lower()
    ...
    def __init__(self, form):
        ...
        self.credit_mix = form.get('credit_mix', '').lower()
        ...
        self.payment_of_min_amount = form.get('payment_of_min_amount', '').lower()
        ...
        self.payment_behaviour = form.get('payment_behaviour', '').lower()
